...
map("n", "<leader>fy", "<cmd>Telescope help_tags<CR>", { desc = "telescope help page" })
...
map("n", "<leader>ff", "<cmd>Telescope find_files previewer=true<cr>", { desc = "telescope find files" })
