...
dashboard.section.buttons.val = {
	...
	dashboard.button("f", "🔍  Find files", ":Telescope find_files no_ignore=true hidden=true <CR>"),
	dashboard.button("n", "📝  Find Notes", ":Telescope find_files cwd=~/Nextcloud/Notes<CR>"),
